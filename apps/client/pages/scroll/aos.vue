  ...
  >
    ...
    <div class="max-w-4xl mx-auto">
      ...
      <div class="grid grid-cols-3 lg:grid-cols-6 gap-4 justify-items-center">
        <img class="h-7" src="~/assets/images/company/google.svg" />
        <img class="h-7" src="~/assets/images/company/netflix.svg" />
        <img class="h-7" src="~/assets/images/company/airbnb.svg" />
        <img
          class="h-7 transform translate-y-2"
          src="~/assets/images/company/amazon.svg"
        />
        <img class="h-7" src="~/assets/images/company/facebook.svg" />
        <img class="h-7" src="~/assets/images/company/grab.svg" />
      </div>
    </div>
    ...
    <div class="grid md:grid-cols-3 gap-14 md:gap-5 mt-20">
      <div class="bg-white shadow-xl p-6 text-center rounded-xl">
        <div
    ...
    >
      <div data-aos="fade-right" class="md:w-6/12">
        <img class="md:w-11/12" src="~/assets/images/true-false.png" />
      </div>
      <div
        data-aos="fade-left"
    ...
    >
      <div data-aos="fade-right" class="md:w-7/12">
        <img class="md:w-11/12" src="~/assets/images/discussion.png" />
      </div>
      <div
        data-aos="fade-left"
    ...
    <div class="mt-24 flex flex-col md:flex-row items-start md:space-x-10">
      <div data-aos="zoom-in-right" class="md:w-6/12">
        <img class="md:w-8/12 mx-auto" src="~/assets/images/integrations.png" />
      </div>
    ...
    >
      <div class="lg:w-6/12">
        <img class="w-full mb-6" src="~/assets/images/laptop-news.png" />
        <span
